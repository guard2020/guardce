...
public class OAuthBearerTokenJwt implements OAuthBearerToken {
    private static final Logger log = LoggerFactory.getLogger(OAuthBearerTokenJwt.class);

    //region Constants

    private static final String SUB = "client_id";
    ...
    public OAuthBearerTokenJwt(Map<String, Object> jwtToken, String accessToken) {
        ...
        // for (Map.Entry<String, Object> entry : jwtToken.entrySet())
        //     log.info("Decoded JWT - Key: {} | Value: {}", entry.getKey(), entry.getValue());
