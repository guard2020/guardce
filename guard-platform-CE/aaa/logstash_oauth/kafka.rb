...
class LogStash::Inputs::Kafka < LogStash::Inputs::Base
  ...
  config :bootstrap_servers, :validate => :string, :default => "kafka:9093"
  ...
  config :ssl_truststore_location, :validate => :path, :default => "/var/private/ssl/kafka.jks"
  # The truststore password
  config :ssl_truststore_password, :validate => :password, :default => "javacaps"
  # The keystore type.
  ...
  config :security_protocol, :validate => ["PLAINTEXT", "SSL", "SASL_PLAINTEXT", "SASL_SSL"], :default => "SASL_SSL"
  # http://kafka.apache.org/documentation.html#security_sasl[SASL mechanism] used for client connections.
  # This may be any mechanism for which a security provider is available.
  # GSSAPI is the default mechanism.
  config :sasl_mechanism, :validate => :string, :default => "GSSAPI"

  config :sasl_login_callback_handler_class, :validate => :string, :default => "org.telematics.guard.aa.kafka.liboauthbearer.OAuthAuthenticateLoginCallbackHandler"
