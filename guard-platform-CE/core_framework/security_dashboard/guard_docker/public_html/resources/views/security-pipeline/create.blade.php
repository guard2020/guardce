...
@section('page-header')
    @include('layouts.page-header', [
        'pageHeadTitle' => 'Create Security Pipeline',
        'breadcrumbs' => [
            [
                'name' => 'Pipeline',
    ...
    <div class="row">
        <div class="col-xl-10 col-12 offset-xl-1">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        {!! Form::open(['route'=>'security-pipeline.store', 'id' => 'smart-dashboard-form', 'enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="row mt-4 text-right">
                                    <div class="col-sm-12">
                                        <div class="form-group ">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-padding-sm legitRipple">Save</button>
