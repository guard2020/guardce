@foreach($selectedInstanceArr as $resourceKey=>$InstanceParamVal)
    @php
        $instance = $InstanceParamVal['algoInstanceId'];
        $instanceParam = $InstanceParamVal['algoInstanceParam'];
        ...
        <div class="row d-flex bg-guard text-left my-0 py-2 mx-auto w-100 align-items-center justify-content-between" role="tab" id="heading-{!! $instance !!}">
            <div class="col-12">
                <div class="heading d-flex">
                    <a data-toggle="collapse" class="algo-expand-source w-100" data-parent="#accordionEx" href="#collapse-resource-{!! $instance !!}" aria-expanded="true"
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered">
                        ...
                        @if(!empty($resourceOptions))
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="7" class="text-center">No config file found for this algorithm instance!</td></tr>
                        @endif
