...
// Define variables
const layout = 'layout_2',      // 'layout_1', 'layout_2', 'layout_3', 'layout_4', 'layout_5'
    theme = 'material',          // 'default', 'material' or 'dark'
    direction = 'LTR',          // 'LTR' or 'RTL'
    type = 'seed',              // 'full' or 'seed'
    iconset = 'icomoon';        // 'icomoon' (default), 'fontawesome', 'material'
const cssPath = theme+'/css';
...
exports.default = series(lint, sass/*, icons*/);
